import argparse
from asr import BartSpeechParser
...
def parse(parser):
    ...
    parser.add_argument('--config', 
                        ...
                        help='config file')
    parser.add_argument('--bart_tokenizer', 
                        default='/opt/data/private/slzhou/PLMs/bart-base-chinese', 
                        help='which bart tokenizer to use')
    # parser.add_argument('--bart_model', 
    #                     default='/opt/data/private/slzhou/PLMs/bart-base-chinese', 
    #                     help='which bart model to use')
    parser.add_argument('--bart_asrcorr', 
                        default='/opt/data/private/slzhou/speech_help_ner/asr_help_ner/exp/bart_ner_distilled_T2_hw0.2_v1/best.model', 
                        help='which bart model to use')
    ...
    parser.add_argument('--max_frame_num',
                        default=512,
                        type=int)
    parser.add_argument('--add_ctc', action="store_true", help='whether to add ctc')
...
if __name__ == '__main__':
    ...
    subparser.add_argument('--beam_size', default=5, type=int, help='beam size')
